...
description: >
  ...
  Obsidian 留存核查與 SRS 文件、Claude Code 串接全流程。觸發關鍵字：
...
| Claude Code | 串接上述三者，執行開發與合規查驗流程 |
...
## Step 3：開發流程嵌入合規查驗（Claude Code + Obsidian）
...
若需要直接從 Claude Code 更新 Obsidian，優先使用：
